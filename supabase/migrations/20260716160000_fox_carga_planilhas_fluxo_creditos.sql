...
-- Gerado em: 2026-07-16T15:27:45.777Z
-- Fontes:
...
('30140610000151', '2026-04-01'::date, 'INSS_52', 298649.81, 103531.88, 0.1500, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('29056262000150', '2026-04-01'::date, 'INSS_52', 67692.16, 10661.95, 0.1250, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('15580294000145', '2026-04-01'::date, 'INSS_52', 83923.47, 10528.74, 0.1250, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('50547492000108', '2026-04-01'::date, 'INSS_52', 207661.36, 34715.17, 0.1250, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('16564133000120', '2026-04-01'::date, 'INSS_52', 195456.07, 49506.16, 0.1500, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('00569560000161', '2026-04-01'::date, 'INSS_52', 126131.94, 32543.88, 0.2000, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('22546657000191', '2026-04-01'::date, 'INSS_52', 52788.54, 31528.11, 0.2000, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('09633032000107', '2026-04-01'::date, 'INSS_52', 52820.87, 12021.02, 0.1500, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('11304945000113', '2026-04-01'::date, 'INSS_52', 226423.82, 63558.80, 0.1500, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('05229674000186', '2026-04-01'::date, 'INSS_52', 64241.29, 18407.55, 0.2000, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('26061062000105', '2026-04-01'::date, 'INSS_52', 5324.60, 1106.41, 0.2000, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('31224769000117', '2026-04-01'::date, 'INSS_52', 75894.46, 37477.79, 0.2000, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('22536813000133', '2026-04-01'::date, 'INSS_52', 256987.31, 66643.45, 0.1500, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('32254332000199', '2026-04-01'::date, 'INSS_52', 34.40, 1438.12, 0.1250, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('50250937000193', '2026-04-01'::date, 'INSS_52', 813.92, 18429.81, 0.1250, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('23672895000106', '2026-04-01'::date, 'INSS_52', 104.92, 8400.34, 0.1250, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[])
ON CONFLICT (cnpj, mes_referencia, tributo_enum) DO UPDATE SET
  valor_compensado = EXCLUDED.valor_compensado,
  honorario_valor = COALESCE(EXCLUDED.honorario_valor, tmp_comp_carga.honorario_valor),
  honorario_percentual = COALESCE(EXCLUDED.honorario_percentual, tmp_comp_carga.honorario_percentual),
...
('30807561000168', '2026-04-01'::date, 'INSS_52', 290.09, 61.44, 0.1250, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('28732157000120', '2026-04-01'::date, 'INSS_52', 441.04, 163.76, 0.1250, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('17479543000136', '2026-04-01'::date, 'INSS_52', 1366.81, 1072.01, 0.1250, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('05904970000135', '2026-04-01'::date, 'INSS_52', 40598.75, 8119.75, 0.2000, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('13373989000120', '2026-04-01'::date, 'INSS_52', 18268.58, 3653.72, 0.2000, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
('20782168000103', '2026-04-01'::date, 'INSS_52', 17325.56, 4926.40, 0.2000, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('30285758000184', '2026-04-01'::date, 'INSS_52', 13373.57, 3832.10, 0.2000, true, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('10440200000119', '2026-04-01'::date, 'INSS_52', 35721.12, 14831.57, 0.2500, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('32352751000163', '2026-04-01'::date, 'INSS_52', 1613743.99, 174569.91, 0.1000, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('04782837000190', '2026-04-01'::date, 'INSS_52', 181062.91, 42348.29, 0.1000, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('33333713000126', '2026-04-01'::date, 'INSS_52', 1488.01, 297.61, 0.2000, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
('18343960000110', '2026-04-01'::date, 'INSS_52', 31766.97, 6358.22, 0.2000, false, NULL, NULL, 'Importado via SQL fluxo (fluxo caixa maio 2026, variante novo)', '{}'::text[]),
...
('28882587000129', '2026-05-01'::date, 'outros', 5538.45, 1384.61, 0.2500, false, NULL, NULL, 'ICMS — importado do formato novo_icms (fluxo jun/26+) | Importado via SQL fluxo (fluxo caixa jun 2026, variante novo_icms)', '{}'::text[]),
('28882587000200', '2026-05-01'::date, 'outros', 4789.61, 1197.40, 0.2500, false, NULL, NULL, 'ICMS — importado do formato novo_icms (fluxo jun/26+) | Importado via SQL fluxo (fluxo caixa jun 2026, variante novo_icms)', '{}'::text[]),
('68746239000149', '2026-05-01'::date, 'outros', 16739.69, 3347.94, 0.2000, false, NULL, NULL, 'ICMS — importado do formato novo_icms (fluxo jun/26+) | Importado via SQL fluxo (fluxo caixa jun 2026, variante novo_icms)', '{}'::text[]),
('68746239000220', '2026-05-01'::date, 'outros', 26947.52, 5389.50, 0.2000, false, NULL, NULL, 'ICMS — importado do formato novo_icms (fluxo jun/26+) | Importado via SQL fluxo (fluxo caixa jun 2026, variante novo_icms)', '{}'::text[])
ON CONFLICT (cnpj, mes_referencia, tributo_enum) DO UPDATE SET
  valor_compensado = EXCLUDED.valor_compensado,
  honorario_valor = COALESCE(EXCLUDED.honorario_valor, tmp_comp_carga.honorario_valor),
  honorario_percentual = COALESCE(EXCLUDED.honorario_percentual, tmp_comp_carga.honorario_percentual),
