...
-- 3) Promove ICMS que entrou como 'outros' (exige PASSO 1 já commitado)
...
WHERE tributo_enum = 'outros'
  AND (
    ...
    OR observacao ILIKE '%tributo ICMS%'
  );

-- 4) Backfill tese_origem_id — FIFO (INSUMOS → SUBVENCAO → demais do cálculo)
