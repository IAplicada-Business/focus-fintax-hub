...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 text-[11px] font-semibold tracking-[-0.005em] transition-colors duration-150 ease-out-modern focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outline: "border-card-border/70 text-foreground",
      },
    },
    defaultVariants: {
      variant: "default",
